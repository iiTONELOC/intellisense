...
export default function Nav() {
    ...
    return (
        <nav navdata='navbar' className="bg-[#070101fd] w-full flex flex-row justify-between items-center text-gray-200 self-start h-16">
            <span className=''>
                <h1 className="ml-3 align-middle text-2xl p-2 hover:text-myLightBlue">
                    <a href='/'><span className="font-medium text-3xl text-myPink">Alfred</span>_Office</a>
                </h1>
            </span>
